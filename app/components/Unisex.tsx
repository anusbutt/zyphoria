...
import { unisexProducts, Product } from "@/lib/products";
  ...
  return (
    <section className="bg-background py-12">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-foreground mb-8 text-center">Unisex Collection</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mx-auto w-fit">
