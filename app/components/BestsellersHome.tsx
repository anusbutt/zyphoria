...
export default function BestsellersHome() {
  ...
  const displayedProducts = bestSellerProducts.slice(0, 4); // Display first 4 products

  const handleToggleLike = (product: typeof displayedProducts[0]) => {
  ...
  const handleAddToCart = (product: typeof displayedProducts[0]) => {
    addToCart(product, 1);
    Swal.fire({
      icon: 'success',
      title: 'Added to Cart!',
    ...
    <section className="bg-background py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          <Link href="/bestsellers" className="text-primary hover:underline text-lg font-semibold">
